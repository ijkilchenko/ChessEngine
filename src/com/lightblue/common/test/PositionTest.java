...
public class PositionTest {
	...
	public void getColorTest() {
		Assert.assertTrue(pos1.getColor() == Position.color.BLACK);
		Assert.assertTrue(pos2.getColor() == Position.color.WHITE);
		Assert.assertTrue(pos3.getColor() == Position.color.WHITE);
		Assert.assertTrue(pos4.getColor() == Position.color.BLACK);
	}
	...
	@Test
	public void convertStringToPositionTest() {
		String str = "h5";
		Position pos = Position.convertStringToPosition(str);
